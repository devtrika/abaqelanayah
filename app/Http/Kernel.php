...
class Kernel extends HttpKernel {
  ...
  protected $middleware = [
    ...
    // \Fruitcake\Cors\HandleCors::class, // Removed as it's not compatible with Laravel 11
  ...
  protected $routeMiddleware = [
    ...
    'website.guest'                     => \App\Http\Middleware\WebsiteRedirectIfAuthenticated::class,
    ...
    'check-client-type'                 => \App\Http\Middleware\CheckClientType::class,
    'is-provider'                       => \App\Http\Middleware\IsProvider::class,
    'is-approved-provider'              => \App\Http\Middleware\IsApprovedProvider::class,
