...
use App\Http\Requests\Admin\fqs\Update;
use App\Models\Fqs ;
...
class FqsController extends Controller
{
    ...
    {
        $audienceTypes = Fqs::query()
            ->whereNotNull('audience_type')
            ->distinct()
            ->pluck('audience_type');
        return view('admin.fqs.create', compact('audienceTypes'));
    }
    ...
    public function edit($id)
    {
        ...
        $audienceTypes = Fqs::query()
            ...
            ->distinct()
            ->pluck('audience_type');
        return view('admin.fqs.edit' , compact('fqs', 'audienceTypes'));
    }
