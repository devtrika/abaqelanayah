...
return [
     ...
     */
    'compression_threshold' => 1024 * 1024 * 10, // 10MB - only compress very large files
    'compression_quality' => 75, // JPEG/WebP quality (1-100) - lower = faster
    'max_image_width' => 1200, // Maximum width in pixels - smaller = faster
    'max_image_height' => 1200, // Maximum height in pixels - smaller = faster
     ...
     */
    'queue_name' => env('MEDIA_QUEUE', 'images'),
