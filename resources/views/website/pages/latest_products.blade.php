...
@section('title', __('site.latest_products') . ' - Lia')

@section('meta_description', __('site.latest_products'))
...
<section class="breadcrumb-section">
  <div class="container">
    <ul class="breadcrumb-list">
      ...
      <li class="breadcrumb-item">
        <a href="{{ route('website.latest') }}" class="breadcrumb-link"> {{ __('site.latest_products') }} </a>
      </li>
    </ul>
  </div>
</section>
...
<section class="page-content">
  <div class="container">
    <form id="filters-form" method="GET" action="{{ route('website.latest') }}">
      <div class="section-head page-head">
        <h1 class="section-title">{{ __('site.latest_products') }}</h1>
