...
<link rel="apple-touch-icon" href="{{ $secureFavicon }}">
<link rel="shortcut icon" type="image/x-icon" href="{{ $secureFavicon }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/css/product-action.css')}}">
