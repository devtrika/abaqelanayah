<div class="main-menu menu-fixed menu-light menu-collapsible menu-shadow" data-scroll-to-active="true" style="background-color: rgb(33,41,54);">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto">
                <a class="navbar-brand" href="{{url('admin/dashboard')}}" style="display: flex; align-items: center; height: 60px; padding: 5px;">
                    <img class="brand-logo img-logo"
                         src="{{$settings['logo']}}"
                         alt="Logo"
                         style="width: 100%;
                                height: 100%;
