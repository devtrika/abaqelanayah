                ...
                <ul class="nav navbar-nav float-right resp-wrap-icon">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            @if(auth('admin')->user()->role)
                                <span class="user-role" style="font-size: 12px; color: #888;"> ({{ auth('admin')->user()->role->name }})</span>
                            @endif
                            </span><span class="user-status">{{__('admin.available')}}</span></div><span><img class="round" src="{{auth('admin')->user()->avatar}}" alt="avatar" height="40" width="40"></span>
                        </a>
