...
<form method="POST" action="{{route('admin.deliveries.store')}}" class="store form-horizontal" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="email" name="email" class="form-control" placeholder="{{__('admin.enter_the_email')}}" data-validation-email-message="{{__('admin.email_formula_is_incorrect')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="password" name="password" class="form-control" placeholder="{{ __('admin.enter_the_password') }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="password" name="password_confirmation" class="form-control" placeholder="{{ __('admin.retype_password') }}" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                        </div>
                                    </div>
                                </div>
