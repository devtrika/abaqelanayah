...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.refundreasons.create') }}" 
    deletebutton="{{ route('admin.refundreasons.deleteAll') }}" 
    :searchArray="[
        {{-- 'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/refundreasons')])
@endsection
