...
<x-admin.table
    ...
    order="true"
    extrabuttons="true"
    deletebutton="{{ route('admin.paymentmethods.deleteAll') }}"
    :searchArray="[
        'name' => [
            'input_type' => 'text' ,
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/paymentmethods')])

    <script>
        $(document).ready(function() {
            // Initialize Switchery for all toggle switches
            var elems = Array.prototype.slice.call(document.querySelectorAll('.switch input[type="checkbox"]'));
            elems.forEach(function(elem) {
                initSingleSwitchery(elem);
            });
        });
    </script>
@endsection
