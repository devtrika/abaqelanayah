                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" value="{{auth('admin')->user()->phone}}" name="phone" class="form-control" placeholder="{{  __('admin.enter_phone_number') }}" required data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="first-name-column">{{ __('admin.name_of_role') }}</label>
                                                <div class="controls">
                                                    <input type="text" id="role" class="form-control" value="{{ auth('admin')->user()->role ? auth('admin')->user()->role->name : '' }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="form-group">
                                                    <label for="first-name-column">{{  __('admin.old_password') }}</label>
                                                    <div class="controls">
                                                        <input type="password" name="old_password" class="form-control"  required data-validation-required-message="{{ __('admin.this_field_is_required') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-12">
