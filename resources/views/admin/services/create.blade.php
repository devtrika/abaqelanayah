        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.services.store')}}" class="store form-horizontal" novalidate>
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <textarea class="form-control" name="description[{{$lang}}]" rows="4" 
                                                              placeholder="{{__('admin.service_description')}} {{__('admin.in_' . $lang)}}" required>{{old('description.' . $lang)}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="number" name="price" class="form-control" step="0.01" min="0" max="999999.99"
                                                       placeholder="{{__('admin.service_price')}}" value="{{old('price')}}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="number" name="duration" class="form-control" min="1" max="1440"
                                                       placeholder="{{__('admin.duration_in_minutes')}}" value="{{old('duration')}}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="number" name="expected_time_to_accept" class="form-control" min="1" max="1440"
                                                       placeholder="{{__('admin.expected_time_in_minutes')}}" value="{{old('expected_time_to_accept')}}" required>
                                            </div>
                                        </div>
                                    </div>
