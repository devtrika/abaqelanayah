...
<x-admin.table
    ...
    order="true"
    extrabuttons="true"
    addbutton="{{ route('admin.gifts.create') }}"
    deletebutton="{{ route('admin.gifts.deleteAll') }}"
    :searchArray="[
        'orders_count' => [
            'input_type' => 'number' ,
            'input_name' => __('admin.orders_count') ,
        ] ,
        'month' => [
            'input_type' => 'date' ,
            'input_name' => __('admin.month') ,
        ] ,
        'is_active' => [
            'input_type' => 'select' ,
            'rows'       => [
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/gifts')])
@endsection
