...
<form method="POST" action="{{ route('admin.gifts.store') }}" class="store form-horizontal" novalidate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="orders_count" class="form-control"
                                                   ...
                                                   name="orders_count" min="1" required>
                                            @error('orders_count')
                                    ...
                                    <div class="col-md-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select name="coupon_id" id="coupon_id" class="form-control select2" required data-validation-required-message="{{__('admin.this_field_is_required')}}">
                                                    <option value="">{{__('admin.choose')}}</option>
                                                    @foreach($coupons as $coupon)
                                                    <option value="{{ $coupon->id }}">{{ $coupon->coupon_num }} ({{ $coupon->discount }}{{ $coupon->type == 'ratio' ? '%' : ' ' . __('admin.currency') }})</option>
                                                @endforeach
                                              </select>
                                              @error('coupon_id')
                                              <span class="alert alert-danger">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">{{ __('admin.add') }}</button>
