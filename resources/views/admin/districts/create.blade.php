        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.districts.store') }}" class="store form-horizontal" novalidate autocomplete="off">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                                ...
                                                <div role="tabpanel" class="tab-pane fade @if($loop->first) show active @endif " id="first_{{$lang}}" aria-labelledby="first_{{$lang}}" aria-expanded="true">
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="name[{{$lang}}]" class="form-control" placeholder="{{__('admin.write') . __('admin.name')}} {{ $lang }}" @if($loop->first) required data-validation-required-message="{{__('admin.this_field_is_required')}}" @endif value="{{ old('name.'.$lang) }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="status" class="form-control" required data-validation-required-message="{{__('admin.this_field_is_required')}}" >
                                                        ...
                                                        <option value="0" @if(old('status') == '0') selected @endif>{{__('admin.inactive')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
