 ...
 <table class="table" id="tab">
    <thead>
        <tr>
            ...
            <th>{{ __('admin.download_invoice') }}</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($orders as $index => $order)
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.reports.payment-report.download-invoice', $order->id) }}" class="btn btn-sm btn-outline-primary" target="_blank">
                        <i class="fa fa-file-pdf-o"></i> {{ __('admin.download_invoice') }}
                    </a>
                </td>
            </tr>
        @endforeach
