...
<x-admin.table
    ...
    order="true"
    extrabuttons="true"
    addbutton="{{ route('admin.product-categories.create') }}"
    deletebutton="{{ route('admin.product-categories.deleteAll') }}"
    :searchArray="[
        'name' => [
            'input_type' => 'text' ,
            'input_name' => __('admin.category_name') ,
        ] ,
           ]"
>
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/product-categories')])
@endsection
