...
<form  method="POST" action="{{route('admin.product-categories.update' , ['id' => $productcategory->id])}}" class="store form-horizontal" novalidate>
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        <div class="form-group">
                                                            <label for="first-name-column">
                                                                {{__('admin.category_name')}} {{ $lang }}
                                                                @if($lang == config('app.locale'))
                                                                    <span class="text-danger">*</span>
                                                                @endif
                                                            </label>
                                                            <div class="controls">
                                                                <input type="text" value="{{$productcategory->getTranslations('name')[$lang]??''}}"
                                                                    name="name[{{$lang}}]" class="form-control"
                                                                    placeholder="{{__('admin.write') . __('admin.category_name')}} {{ $lang }}"
