    ...
    <table class="table " id="tab">
        <thead>
            <tr>
                ...
                <th>{{__('admin.image')}} ({{__('admin.ar')}})</th>
                <th>{{__('admin.image')}} ({{__('admin.en')}})</th>
        ...
        <tbody>
            @foreach($images as $image)
                <tr class="delete_image">
                    ...
                    <td>{{$image->name}}</td>
                    <td><img src="{{$image->image_ar}}" width="30px" height="30px" alt=""></td>
                    <td><img src="{{$image->image_en}}" width="30px" height="30px" alt=""></td>
