    ...
    <div class="container-xxl ">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-4">
          <!-- Login -->
          <div class="card" style="direction: {{ lang() == 'ar' ? 'rtl':'ltr' }}; width: max-content;">
            <div class="card-body">
              <!-- Logo -->
                             <div class="app-brand justify-content-center mb-2 mt-2">
                 <a href="#" class="app-brand-link gap-2" style="display: flex; align-items: center; flex-direction: column;">
                   <span class="app-brand-logo demo" style="display: flex; align-items: center; justify-content: center; max-height: 120px; margin-bottom: 10px;">
                     <img class="w-100"
                          src="{{$data['logo']}}"
                          alt="branding logo"
                   ...
                   <span class="app-brand-text demo text-body fw-bold ms-1 mb-2">{{$data['name_'.lang()]}}</span>
                 </a>
               </div>
               <!-- /Logo -->
                              <h4 class="mb-2 pt-0">{{__('site.hi')}} {{$data['name_'.lang()]}} 👋</h4>
               {{-- <p class="mb-4">Please sign-in to your account and start the adventure</p> --}}

               <form id="formAuthentication" class="mb-2" action="{{route('admin.login')}}"  method="POST">
                 @csrf
                 <div class="mb-2">
