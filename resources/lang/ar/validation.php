...
return [
  ...
  'phone_format'         => 'يجب أن يكون :attribute رقم هاتف سعودي',
  'password_min' => 'يجب أن تتكون كلمة المرور من 8 أحرف أو أرقام على الأقل.',
  ...
  'custom'               => [
    ...
    'name' => [
      ...
      'min' => 'الاسم يجب أن يكون على الأقل 3 أحرف.',
      'max' => 'الاسم يجب ألا يزيد عن 60 حرف.',
      'regex' => 'الاسم يجب أن يحتوي على حروف فقط.',
    ],
  ],
  ...
  'attributes'           => [
    ...
    // Provider Registration Attributes
    'commercial_name'           => 'الاسم التجاري',
    'commercial_name.ar'        => 'الاسم التجاري (عربي)',
    'commercial_name.en'        => 'الاسم التجاري (انجليزي)',
    ...
    'full_name'                 =>'الاسم كامل',
      ...
      'recipient_name' => 'اسم المستلم',
          ...
          'reciver_phone' =>'رقم المستلم',
          'gift_address_name' =>' عنوان الهديه ',
          'hide_sender' => 'اخفاء المرسل',
          'problem_id' => 'المشكله',
          'notes' =>' ملاحظات',
'payment_method_id' => 'معرّف وسيلة الدفع', // Payment method ID  
'delivery_type' => 'نوع التوصيل',           // Delivery type  
'address_id' => 'معرّف العنوان',            // Address ID  
'latitude' => 'خط العرض',                   // Latitude  
'order_id' => 'معرّف الطلب',           // Order ID  
'cancel_reason_id' => 'معرّف سبب الإلغاء', // Cancel reason ID  
